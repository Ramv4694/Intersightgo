...
type AssetOrchestrationHsmVmwareVcenterOptions struct {
	...
	// The client secret used to authenticate managed target with Intersight.
...
func (o *AssetOrchestrationHsmVmwareVcenterOptions) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varAssetOrchestrationHsmVmwareVcenterOptions.ClientSecret = varAssetOrchestrationHsmVmwareVcenterOptionsWithoutEmbeddedStruct.ClientSecret
