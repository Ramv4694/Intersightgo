...
[**TaskHyperFlexManagementScopedInventory**](task.HyperFlexManagementScopedInventory.md)
...
[**TaskHyperflexScopedInventory**](task.HyperflexScopedInventory.md)
...
[**TaskIweScopedInventory**](task.IweScopedInventory.md)
...
[**TaskServerScopedInventory**](task.ServerScopedInventory.md)
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TaskApi.CreateTaskWorkflowAction(context.Background()).TaskWorkflowAction(taskWorkflowAction).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
...
[**TaskWorkflowAction**](task.WorkflowAction.md)
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TaskApi.GetTaskWorkflowActionByMoid(context.Background(), moid).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TaskApi.GetTaskWorkflowActionList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
...
[**TaskWorkflowActionResponse**](task.WorkflowAction.Response.md)
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TaskApi.PatchTaskWorkflowAction(context.Background(), moid).TaskWorkflowAction(taskWorkflowAction).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TaskApi.UpdateTaskWorkflowAction(context.Background(), moid).TaskWorkflowAction(taskWorkflowAction).IfMatch(ifMatch).Execute()
    if err != nil {
