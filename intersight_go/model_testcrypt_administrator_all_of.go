...
type _TestcryptAdministratorAllOf TestcryptAdministratorAllOf
...
func (o *TestcryptAdministratorAllOf) SetAdminNil() {
	o.Admin.Set(nil)
}
...
func (o *TestcryptAdministratorAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTestcryptAdministratorAllOf := _TestcryptAdministratorAllOf{}

	if err = json.Unmarshal(bytes, &varTestcryptAdministratorAllOf); err == nil {
		*o = TestcryptAdministratorAllOf(varTestcryptAdministratorAllOf)
	}
