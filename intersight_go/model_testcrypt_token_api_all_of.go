...
type _TestcryptTokenApiAllOf TestcryptTokenApiAllOf
...
func (o *TestcryptTokenApiAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTestcryptTokenApiAllOf := _TestcryptTokenApiAllOf{}

	if err = json.Unmarshal(bytes, &varTestcryptTokenApiAllOf); err == nil {
		*o = TestcryptTokenApiAllOf(varTestcryptTokenApiAllOf)
	}
