...
func (o *TestcryptUser) UnmarshalJSON(bytes []byte) (err error) {
	type TestcryptUserWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varTestcryptUserWithoutEmbeddedStruct := TestcryptUserWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varTestcryptUserWithoutEmbeddedStruct)
	if err == nil {
		varTestcryptUser := _TestcryptUser{}
		varTestcryptUser.ClassId = varTestcryptUserWithoutEmbeddedStruct.ClassId
		varTestcryptUser.ObjectType = varTestcryptUserWithoutEmbeddedStruct.ObjectType
		varTestcryptUser.IsPasswordSet = varTestcryptUserWithoutEmbeddedStruct.IsPasswordSet
		varTestcryptUser.Password = varTestcryptUserWithoutEmbeddedStruct.Password
		varTestcryptUser.Username = varTestcryptUserWithoutEmbeddedStruct.Username
	...
	err = json.Unmarshal(bytes, &varTestcryptUser)
	if err == nil {
		o.MoBaseComplexType = varTestcryptUser.MoBaseComplexType
	} else {
		return err
	}
